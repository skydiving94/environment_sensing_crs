...
def get_all_task_spec_paths() -> Dict[str, str]:
    ...
    """
    # TODO: @Timothy, Implement the actual functionality so it can load dynamically.
    # Should this be read from .env? Or from a configuration file?
    if os.getenv('USER') == 'timowang':
        task_spec_paths = {
            'draw_more_info': '/Users/timowang/Developer/environment_sensing_crs/resources/task_specs/draw_more_info/v0.json',
            'pick_a_task': '/Users/timowang/Developer/environment_sensing_crs/resources/task_specs/pick_a_task/v0.json',
        }
    else:
        task_spec_paths = {
